        ...
        <Mx w={900}>
          ...
          <Rv delay={150}>
            <div className="g3" style={{ marginTop: 2, display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: "clamp(10px,1.5vw,18px)" }}>
              {[
                ...
                { label: "Opening Date", value: "2 June MMXXVI" },
                { label: "Second City", value: "Dublin, December MMXXVI" },
                { label: "Pronunciation", value: "House of Clio" },
                { label: "Tagline", value: "Every brilliant person you have not met yet." },
          ...
          <Rv delay={200}>
            <div style={{ marginTop: 2, padding: "36px 40px", background: T.white, border: `1px solid rgba(46,18,64,.08)`, display: "flex", gap: 28, alignItems: "flex-start" }}>
              ...
              <div style={{ flex: 1 }}>
                ...
                <div style={{ marginTop: 16, fontFamily: F.body, fontSize: 11, fontWeight: 400, color: TX.onLightMuted, fontStyle: "italic" }}>Headshot and assets available on request.</div>
              </div>
            </div>
          </Rv>
          ...
          <Rv delay={250}>
            <div style={{ marginTop: 48 }}>
              ...
              <div className="g2" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "clamp(10px,1.5vw,18px)" }}>
                {[
                  { angle: "The Friendship Economy", pitch: <>{BRAND_AKAN} is the considered end of that market: composed rooms where people are placed beside people worth knowing, with written portraits shared before anyone arrives. Most accomplished people in this city can name two hundred professional contacts and three close friends. The {AKAN_O}use exists for the second number.</> },
                  ...
                  { angle: "The Company You Keep", pitch: <>Many of the men in this city have no one to call on a Sunday. The {AKAN_O}use is composed for them too. Adult friendship is harder than it has ever been. We built the room to make it easier.</> },
                  { angle: "Designed for Both Men and Women", pitch: <>{BRAND_AKAN} is designed for both men and women. The Circle includes people from London, Accra, and Kumasi. The room is composed for range, not for any single profile.</> },
          ...
          <Rv delay={300}>
            ...
            <div style={{ marginTop: 48, marginBottom: 48 }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: "clamp(10px,1.5vw,18px)" }} className="g2">
                {[
                  { n: "Twenty", unit: "years", label: "In tourism, conferences, and incentive travel" },
                  { n: "Three", unit: "continents", label: "Europe, Middle East, West Africa" },
                  { n: "Two", unit: "companies", label: "Inska Hub and Accra Konnect" },
                  { n: "Four", unit: "cities", label: "London · Accra · Dublin · Liguria" },
            ...
            <div style={{ marginBottom: 48 }}>
              ...
              <div style={{ display: "flex", flexWrap: "wrap", gap: 8 }}>
                {["Adult friendship", "The loneliness economy", "Private dining culture", "Composed gatherings", "African diaspora entrepreneurship", "The death of the third place", "Cultural institutions for the twenty first century", "Hospitality as craft", "Small by design", "The art of introduction"].map((t, i) =>
          ...
          <Rv delay={400}>
            <div style={{ marginTop: 48, textAlign: "center", marginBottom: 0 }}>
              ...
              <p style={{ fontFamily: F.body, fontSize: "clamp(13px,3vw,14px)", fontWeight: 400, lineHeight: 1.8, color: TX.onLightSub, marginBottom: 28 }}>Full brand guidelines pack available on request. Press enquiries are answered promptly.</p>

              {/* Downloadable assets */}
              <div style={{ display: "flex", flexWrap: "wrap", gap: 10, justifyContent: "center", marginBottom: 32 }}>
                {[
                  { label: "Muse Mark (Dark)", href: "/press/muse-mark-dark.png" },
                  { label: "Muse Mark (Light)", href: "/press/muse-mark-light.png" },
                  { label: "Headshot — Gigi Brown", href: "/press/gigi-brown-headshot.jpg" },
                  { label: "Brand Guidelines (PDF)", href: "/press/brand-guidelines.pdf" },
                ].map((a, i) => (
                  <a key={i} href={a.href} download style={{ fontFamily: F.body, fontSize: "clamp(9px,2vw,10px)", fontWeight: 500, letterSpacing: ".18em", textTransform: "uppercase", color: T.rose, border: `1px solid ${T.rose}30`, padding: "10px 20px", textDecoration: "none", display: "inline-flex", alignItems: "center", gap: 6, transition: "border-color .3s,background .3s" }}
                    onMouseEnter={e => { e.currentTarget.style.borderColor = T.rose; e.currentTarget.style.background = `${T.rose}06`; }}
                    onMouseLeave={e => { e.currentTarget.style.borderColor = `${T.rose}30`; e.currentTarget.style.background = "none"; }}
                  >
                    <svg width="11" height="11" viewBox="0 0 12 12" fill="none" aria-hidden="true"><path d="M6 1v7M3 5l3 3 3-3M1 10h10" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" /></svg>
                    {a.label}
                  </a>
                ))}
              </div>
