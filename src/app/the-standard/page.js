    ...
    <>
      ...
      <Sec bg={T.bg}>
        <Mx w={640}><Rv>
          ...
          <h1 style={{ fontFamily: F.display, fontSize: "clamp(32px,4.5vw,52px)", fontWeight: 400, lineHeight: .92, color: T.cream, marginBottom: 36 }}>The Standard.<br /><em style={{ color: T.rose }}>How the Ɔuse holds together.</em></h1>
          <Dv w="48px" m="0 0 28px" />
          <p style={{ fontFamily: F.body, fontSize: 16, fontWeight: 400, lineHeight: 2.2, color: TX.onDarkSub, maxWidth: "58ch" }}>We did not write these to tell anyone how to behave. We wrote them because the people who already live this way are the ones who make every room at the Ɔuse worth being in.</p>
        </Rv></Mx>
      </Sec>
            ...
            <div style={{ position: "relative", zIndex: 1, background: T.cream, boxShadow: "0 16px 64px rgba(0,0,0,.3)" }}>
              ...
              <div style={{ position: "relative", zIndex: 2, padding: "clamp(36px,5vh,56px) clamp(32px,5vw,56px)" }}>
                ...
                <div style={{ marginTop: 28, display: "flex", justifyContent: "space-between", alignItems: "flex-end" }}>
                  <div style={{ fontFamily: F.body, fontSize: 10, fontWeight: 300, color: TX.onLightMuted, letterSpacing: ".08em" }}>Ɔuse Ɔf Clio · The Standard</div>
