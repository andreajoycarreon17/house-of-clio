      ...
      <Sec bg={T.damson} style={{ position: "relative" }}>
        ...
        <Mx w={880}><Rv>
          ...
          <div className="g2" style={{ display: "grid", gridTemplateColumns: "repeat(2,1fr)", gap: "clamp(12px,1.5vw,20px)" }}>
            {[
              { title: "The First House", desc: "Where the circle forms. You arrive knowing no one. A host says your name. By the end of the evening, strangers are making plans that did not exist three hours ago.", foot: "London · Seasonal", bg: `linear-gradient(155deg, ${T.copper}, #9A5A2A, #8A4A1A)`, txt: T.cream, sub: "rgba(250,244,238,.75)", acc: T.goldL },
