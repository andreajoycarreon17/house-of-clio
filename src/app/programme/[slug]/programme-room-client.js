      ...
      <section style={{ background: `linear-gradient(145deg,${T.copper},#C47A3A,#8A4A1A)`, padding: "clamp(48px,7vh,72px) clamp(40px,6vw,80px)", position: "relative", overflow: "hidden", textAlign: "center" }}>
        ...
        <Mx w={400}>
          <Rv>
            ...
            <p style={{ fontFamily: F.body, fontSize: 11, fontWeight: 300, color: "rgba(13,1,24,.25)", fontStyle: "italic", maxWidth: "38ch", margin: "0 auto 28px" }}>Social architecture for people who have outgrown networking. Every room you enter makes the next one richer.</p>
            ...
            <p style={{ fontFamily: F.body, fontSize: 10, fontWeight: 300, color: TX.onCopperSub, marginTop: 16, opacity: 0.5 }}>No membership fee. You pay only for the rooms you attend. <Link href="/book" {...hp} style={{ color: "inherit", borderBottom: "1px solid rgba(13,1,24,.08)", textDecoration: "none" }}>View the programme and prices</Link>.</p>
          </Rv>
        </Mx>
      </section>
    </>
