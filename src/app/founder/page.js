        ...
        <Mx w={920}>
                ...
                <div style={{ position: "relative", overflow: "hidden" }}>
                  ...
                  <div style={{ position: "relative", zIndex: 2, padding: "clamp(28px,4vh,48px) clamp(24px,5vw,48px) clamp(28px,4vh,48px) clamp(24px,4vw,40px)" }}>
                    ...
                    {[
                      ...
                      { t: null },
                      { t: "Everybody designs the venue. Everybody fusses over the menu. Nobody thinks carefully enough about the people. That is why most dinners are forgettable and most members clubs are expensive loneliness.", s: "b" },
                      { t: null },
          ...
          <Rv delay={150}>
            <div style={{ maxWidth: 700, margin: "56px auto 0" }}>
              ...
              {/* Contact */}
              <div style={{ marginTop: 36, paddingTop: 24, borderTop: `1px solid rgba(201,149,108,.06)`, display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                <div style={{ fontFamily: F.body, fontSize: "clamp(11px,2.5vw,12px)", fontWeight: 400, color: TX.onDarkMuted }}>gigi@thehouseofclio.com</div>
                <address style={{ fontFamily: F.body, fontSize: 10, fontWeight: 400, color: T.rose, opacity: .5, fontStyle: "normal" }}>thehouseofclio.com</address>
              </div>
            </div>
          </Rv>
